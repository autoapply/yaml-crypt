...
describe('crypto', () => {
    it('should return the encrypted content (fernet)', () => {
        const result = crypto.encrypt('fernet', 'aehae5Ui0Eechaeghau9Yoh9jufiep7H', 'Hello, world!');
    ...
    it('should return the encrypted content (branca)', () => {
        const result = crypto.encrypt('branca', 'aehae5Ui0Eechaeghau9Yoh9jufiep7H', 'Hello, world!');
    ...
    it('should throw an error when passing null', () => {
        expect(() => crypto.decrypt('fernet', '', null)).to.throw(/message is null/);
    });

    it('should throw an error when passing invalid data', () => {
        expect(() => crypto.decrypt('fernet', '', {})).to.throw(/invalid type for message/);
    });
